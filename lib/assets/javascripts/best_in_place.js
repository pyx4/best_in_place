...
BestInPlaceEditor.prototype = {
  ...
  update : function() {
    ...
    if (this.formType == "select") {
      ...
      value = this.getValue()
      editor.element.html(value.replace(/\n/g, '<br />'))
    }
    ...
    if(data && data!=""){
      ...
      if (response !== null && response.hasOwnProperty("display_as")) {
        if (this.formType == "textarea") {
          this.original_content = this.element.html().replace(/<br *\/?>/gi, '\n');
        }
        else {
        ...
        if (response["display_as"] != "" && response["display_as"] != null) {
          ...
          this.element.html($(this.element).attr("data-nil"));
        }
      }
...
BestInPlaceEditor.forms = {
  "input" : {
    activateForm : function() {
      ...
      tmpStr = this.element.find("input[type='text']").val();
      this.element.find("input[type='text']").val('');
      this.element.find("input[type='text']").val(tmpStr);

      this.element.find("form").bind('submit', {editor: this}, BestInPlaceEditor.forms.input.submitHandler);
      if (this.cancelButton) {
        this.element.find("input[type='button']").bind('click', {editor: this}, BestInPlaceEditor.forms.input.cancelButtonHandler);
      }
      // blur event not managed anymore
  ...
  "textarea" : {
    activateForm : function() {
      ...
      tmpStr = this.element.find("textarea").val();
      this.element.find("textarea").val('');
      this.element.find("textarea").val(tmpStr);
